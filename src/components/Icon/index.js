...
const Icons = {
  ...
  'category-hospitality': <CategoryHospitality />,
  ...
  'sub-category-board-room': <SubCategoryBoardRoom />,
  ...
  'sub-category-foodtruck': <SubCategoryFoodtruck />,
  ...
  'sub-category-popup-retail': <SubCategoryPopupRetail />,
  ...
  'sub-category-training-room': <SubCategoryTrainingRoom />,
  'sub-category-venue': <SubCategoryVenue />,
  'sub-category-wedding-venue': <SubCategoryWeddingVenue />,
