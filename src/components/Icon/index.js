...
import { ReactComponent as Amenitie27Per7 } from './svg/amenities/amenities_27_7access.svg'
...
import { ReactComponent as AmenitieAcessible } from './svg/amenities/amenities_acessible.svg'
...
const Icons = {
  ...
  'amenitie-3rdparty': <Amenitie3rdParty />,
  'amenitie-27per7': <Amenitie27Per7 />,
  'amenitie-ac-unit': <AmenitieAcUnit />,
  'amenitie-accomodation': <AmenitieAccomodation />,
  'amenitie-acessible': <AmenitieAcessible />,
  'amenitie-alarm': <AmenitieAlarm />,
  'amenitie-alcohol-license': <AmenitieAlcoholLicense />,
  'amenitie-av-equip': <AmenitieAvEquip />,
  'amenitie-bartender': <AmenitieBartender />,
  'amenitie-beachfront': <AmenitieBeachfront />,
  'amenitie-bike-friendly': <AmenitieBikeFriendly />,
  'amenitie-boat-ramp': <AmenitieBoatRamp />,
  'amenitie-cafe': <AmenitieCafe />,
  'amenitie-cctv': <AmenitieCCTV />,
  'amenitie-chairs': <AmenitieChairs />,
  'amenitie-changing-rooms': <AmenitieChangingRooms />,
  'amenitie-childFriendly': <AmenitieChildFriendly />,
  'amenitie-clothing-racks': <AmenitieClothingRacks />,
  'amenitie-coffeeTea': <AmenitieCoffeeTea />,
  'amenitie-cold-storage': <AmenitieColdStorage />,
  'amenitie-cooler': <AmenitieCooler />,
  'amenitie-dancefloor': <AmenitieDancefloor />,
  'amenitie-entertainment': <AmenitieEntertainment />,
  'amenitie-filteredwater': <AmenitieFilteredwater />,
  'amenitie-fitness-equipment': <AmenitieFitnessEquipment />,
  'amenitie-floral-service': <AmenitieFloralService />,
  'amenitie-free-beer': <AmenitieFreeBeer />,
  'amenitie-fully-serviced': <AmenitieFullyServiced />,
  'amenitie-firnished': <AmenitieFurnished />,
  'amenitie-gas': <AmenitieGas />,
  'amenitie-gym': <AmenitieGym />,
  'amenitie-high-ceillings': <AmenitieHighCeillings />,
  'amenitie-host': <AmenitieHost />,
  'amenitie-indoor': <AmenitieIndoor />,
  'amenitie-house-catering': <AmenitieInHouseCatering />,
  'amenitie-kitchen-equip': <AmenitieKitchenEquip />,
  'amenitie-kitchen': <AmenitieKitchen />,
  'amenitie-live-band-facility': <AmenitieLiveBandFacility />,
  'amenitie-loading-dock': <AmenitieLoadingDock />,
  'amenitie-low-ceilings': <AmenitieLowCeilings />,
  'amenitie-mailbox': <AmenitieMailBox />,
  'amenitie-marquee': <AmenitieMarquee />,
  'amenitie-mirrors': <AmenitieMirrors />,
  'amenitie-offsite-parking': <AmenitieOffsiteParking />,
  'amenitie-onsite-parking': <AmenitieOnsiteParking />,
  'amenitie-outdoor-covered': <AmenitieOutDoorCovered />,
  'amenitie-pets-allowed': <AmenitiePetsAllowed />,
  'amenitie-phonline': <AmenitiePhoneline />,
  'amenitie-photograph-serivce': <AmenitiePhotographService />,
  'amenitie-pool': <AmenitiePool />,
  'amenitie-pooltable': <AmenitiePoolTable />,
  'amenitie-power-outlets': <AmenitiePowerOutlets />,
  'amenitie-printer': <AmenitiePrinter />,
  'amenitie-production-equip': <AmenitieProductionEquip />,
  'amenitie-secureEletronicEntry': <AmenitieElectronicEntry />,
  'amenitie-secure-premises': <AmenitieSecurePremises />,
  'amenitie-security-patrols': <AmenitieSecurityPatrols />,
  'amenitie-self-storage': <AmenitieSelfStorage />,
  'amenitie-shower': <AmenitieShower />,
  'amenitie-storage-loocks': <AmenitieStorageLoocks />,
  'amenitie-store-room': <AmenitieStoreRoom />,
  'amenitie-tables': <AmenitieTables />,
  'amenitie-table-tennis': <AmenitieTabletennis />,
  'amenitie-temperature-control': <AmenitieTemperatureControl />,
  'amenitie-trolly-access': <AmenitieTrollyAccess />,
  'amenitie-tv': <AmenitieTv />,
  'amenitie-underground': <AmenitieUnderground />,
  'amenitie-vehicle-access': <AmenitieVehicleAccess />,
  'amenitie-video-conference': <AmenitieVideoConference />,
  'amenitie-wedding-cake': <AmenitieWeddingCake />,
