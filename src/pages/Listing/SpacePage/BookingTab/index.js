    ...
    <Grid columns={1} rowGap="80px">
      ...
      <Cell>
        ...
        <Grid columns={8} columnGap="20px">
          <Cell width={1}>
            <Radio value="monthly" checked={select === 'monthly'} handleChange={handleSelectChange} label="1 day" />
          </Cell>
          <Cell width={1}>
            <Radio value="monthly" checked={select === 'monthly'} handleChange={handleSelectChange} label="2 days" />
          </Cell>
          <Cell width={1}>
            <Radio value="monthly" checked={select === 'monthly'} handleChange={handleSelectChange} label="5 days" />
          </Cell>
          <Cell width={1}>
            <Radio value="monthly" checked={select === 'monthly'} handleChange={handleSelectChange} label="7 days" />
          </Cell>
        </Grid>
      </Cell>
      <Cell>
